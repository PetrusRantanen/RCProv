...
new class extends Component
{
    ...
    public $offerSettingsReset;

    public $firmware;

    public $eeprom_settings;
    ...
    public $beta_firmware;

    public $stable_firmware;
    ...
    public function render()
    {
        ...
        $this->stable_firmware = json_decode(json_encode(Firmware::allOfChannel('latest'), true));
    ...
    {
        Project::destroy($id);
        session()->flash('message', 'Projekti poistettu.');
    }
    ...
    public function setEepromSettings(&$data, $settings)
    {
        $MAGIC = 0x55AAF00F;
        ...
        while ($offset + 8 < strlen($data)) {
            [$magic, $len] = array_values(unpack('Nmagic/Nlen', $data, $offset));
    ...
    public function getEepromSettingsFromFirmwareFile($fn)
    {
    ...
    public function getEepromSettings(&$data)
    {
        $MAGIC = 0x55AAF00F;
        $MAGIC_MASK = 0xFFFFF00F;
        $FILE_MAGIC = 0x55AAF11F;
